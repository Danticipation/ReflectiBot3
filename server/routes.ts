...
<head>
    ...
    <style>
        ...
        .gradient-bg { background: linear-gradient(135deg, #1f2937, #111827, #000); }
    </style>
</head>
<body class="gradient-bg text-white min-h-screen">
    <div class="container mx-auto max-w-4xl px-4 py-6">
        ...
        <div class="text-center mb-8">
            <h1 class="text-4xl font-bold text-emerald-400 mb-2">🪞 Mirror Bot</h1>
            <p class="text-gray-400 text-lg">Advanced AI companion that learns and speaks</p>
        ...
        <div class="bg-gray-800 rounded-xl border border-gray-700 shadow-2xl overflow-hidden">
            ...
            <div id="chatArea" class="h-96 overflow-y-auto p-6 space-y-4">
                <div id="welcomeMessage" class="text-center py-20">
                    ...
                    <h3 class="text-xl font-semibold text-gray-300 mb-2">Welcome to Mirror Bot!</h3>
                    <p class="text-gray-500">Start a conversation and watch me learn from you.</p>
                    <p class="text-gray-500 text-sm mt-2">I'll speak my responses and adapt to your style.</p>
                </div>
            </div>
            ...
            <div class="border-t border-gray-700 p-4">
                <div class="flex gap-3">
                    <div class="flex-1">
                        <input
                            ...
                            class="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500"
                        />
                    </div>
                    
                    <button
                        id="voiceBtn"
                        class="px-4 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-xl transition-all duration-200"
                        title="Voice Input"
                    >
                        🎤
                    </button>
                    ...
                    <button
                        id="sendBtn"
                        class="px-6 py-3 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl font-medium transition-all duration-200"
                    >
                        Send
                    </button>
                </div>
                ...
                <div class="flex justify-between items-center mt-3 text-xs text-gray-500">
                    <div id="statusArea" class="flex gap-4"></div>
    ...
    <script>
        ...
        let botStats = { level: 1, wordsLearned: 0, stage: 'Infant' };
        ...
        function setListening(listening) {
            ...
            if (listening) {
                voiceBtn.className = 'px-4 py-3 bg-red-600 text-white rounded-xl animate-pulse';
                statusArea.innerHTML = '<span class="text-red-400">🎤 Listening...</span>';
            } else {
                voiceBtn.className = 'px-4 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-xl transition-all duration-200';
                updateStatus();
            }
        }
        ...
        function updateBotStats(stats) {
            if (stats.level) {
                ...
                document.getElementById('botStage').textContent = stats.level === 1 ? 'Infant' : stats.level === 2 ? 'Child' : stats.level === 3 ? 'Adolescent' : 'Adult';
            }
        ...
        function addMessage(content, isUser, timestamp = new Date()) {
            ...
            messageDiv.innerHTML = \`
                <div class="max-w-xs lg:max-w-md px-4 py-3 rounded-2xl \${bgClass}">
        ...
        function showTyping() {
            ...
            typingDiv.innerHTML = \`
                <div class="bg-gray-700 border border-gray-600 px-4 py-3 rounded-2xl">
                    <div class="flex items-center space-x-1">
                        <div class="w-2 h-2 bg-emerald-400 rounded-full typing" style="animation-delay: 0s"></div>
                        <div class="w-2 h-2 bg-emerald-400 rounded-full typing" style="animation-delay: 0.2s"></div>
                        <div class="w-2 h-2 bg-emerald-400 rounded-full typing" style="animation-delay: 0.4s"></div>
                    </div>
                </div>
            \`;
